 ...
 * 
 * 设计原则：
 * 1. 深色背景：触发器和下拉菜单使用深色背景
 * 2. 发光边框：聚焦时显示蓝色发光效果
 * 3. 玻璃拟态：下拉菜单使用半透明效果
 * 4. 悬停效果：选项悬停时显示微妙背景变化
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "border border-border-primary bg-bg-tertiary px-4 py-2.5",
      "text-sm text-text-primary ring-offset-bg-primary",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretDown className="h-4 w-4 shrink-0 text-text-muted" />
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border border-border-primary bg-bg-secondary/95 backdrop-blur-xl",
