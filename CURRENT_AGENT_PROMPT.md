...
> **分支**：`prompt/agent-frontend`  
> **角色**：**Agent-Frontend** — Next.js 前端

## 主提示词（必读）

请 **完整阅读并遵守**：**`docs/prompts/agent-frontend.prompt.md`**，并辅以：
...
- 实现功能时从 **develop** 拉出 `feature/frontend-*`，通过 PR/MR 合回 **develop**。
